...
Decl :: { Decl }
Decl : Id { AbsCpp.Test $1 } | Id '=' Exp { AbsCpp.Test2 $1 $3 }
Stm :: { Stm }
...
Exp16 : Integer { AbsCpp.EInt $1 }
      ...
      | 'false' { AbsCpp.EFalse }
      | Id { AbsCpp.EId $1 }
      | Exp16 '(' ListExp ')' { AbsCpp.ECall $1 $3 }
      | Exp16 '[' Exp ']' { AbsCpp.EIndex $1 $3 }
      | '(' Exp ')' { $2 }
Exp15 :: { Exp }
Exp15 : Exp16 '.' Exp16 { AbsCpp.EStut $1 $3 }
...
Exp7 : Exp8 { $1 }
Id :: { Id }
Id : Id1 { $1 } | ListQuaConstId { AbsCpp.IId $1 }
Id1 :: { Id }
Id1 : '(' Id ')' { $2 }
ListExp :: { [Exp] }
ListExp : {- empty -} { [] }
