...
Def : Type Id '(' ListArg ')' '{' ListStm '}' { AbsCpp.DFun $1 $2 $4 $7 }
    | Type Id '(' ListArg ');' { AbsCpp.DFunn $1 $2 $4 }
    | Decl { AbsCpp.DDecl $1 }
...
Exp15 : Integer { AbsCpp.EInt $1 }
      ...
      | 'false' { AbsCpp.EFalse }
      | Id { AbsCpp.EId $1 }
      | Id '::' ListId { AbsCpp.EQuaConst $1 $3 }
      | Id '(' ListExp ')' { AbsCpp.ECall $1 (reverse $3) }
      | '(' Exp ')' { $2 }
Exp14 :: { Exp }
Exp14 : Exp '[' Exp ']' { AbsCpp.EIndex $1 $3 }
...
Exp13 : '++' Exp14 { AbsCpp.EIncr $2 }
      ...
      | '*' Exp14 { AbsCpp.EDere $2 }
      | '!' Exp14 { AbsCpp.ENege $2 }
      | '-' Exp14 { AbsCpp.ENeg $2 }
      | Exp14 { $1 }
Exp12 :: { Exp }
